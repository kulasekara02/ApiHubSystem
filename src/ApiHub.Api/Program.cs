...
if (app.Environment.IsDevelopment())
{
    ...
    {
        options.SwaggerEndpoint("/swagger/v1/swagger.json", "ApiHub API v1");
        options.SwaggerEndpoint("/swagger/v2/swagger.json", "ApiHub API v2");
    });
}
...
Log.Information("ApiHub API starting up...");
